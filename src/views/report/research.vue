...
const statsCards = [
  ...
  { label: '生成中', value: '2份', icon: DataAnalysis, bg: 'linear-gradient(135deg, #10b981, #059669)' },
  { label: '已完成', value: '30份', icon: MagicStick, bg: 'linear-gradient(135deg, #3b82f6, #2563eb)' }
]
