...
export async function fetchQAAnswer(question: string, history: { role: string; content: string }[]): Promise<{ answer: string; sources: QASource[] }> {
  ...
  const answers: Record<string, string> = {
    '灵活就业人员如何缴纳养老保险？': `灵活就业人员参加企业职工基本养老保险，按以下规定办理：

1. **参保条件**：年满16周岁以上、未达到法定退休年龄的灵活就业人员，可以个人身份申请参加企业职工基本养老保险。

2. **缴费基数**：可在当地上年度全口径城镇单位就业人员平均工资的60%至300%之间自主选择缴费基数。

3. **缴费比例**：灵活就业人员参加企业职工基本养老保险的缴费比例为20%，其中8%计入个人账户。

4. **办理渠道**：
   - 线上：通过"掌上12333"APP、电子社保卡、各地人社网上服务平台办理
   - 线下：携带身份证到当地社保经办机构窗口办理

5. **所需材料**：本人有效身份证件（或社会保障卡）。

> AI生成，仅供业务参考。具体以当地社保经办机构最新政策为准。`,
    '失业后怎样申领失业保险待遇？': `失业人员申领失业保险待遇，按以下流程办理：
...
3. **申领渠道**：
   - 线上：国家社会保险公共服务平台、电子社保卡、各地人社APP
   - 线下：参保地社保经办机构窗口

4. **待遇标准**：失业保险金标准按照当地最低工资标准的一定比例确定，具体比例由各省、自治区、直辖市确定，一般为最低工资标准的70%-90%。

5. **领取期限**：缴费满1年不足5年的，最长领取12个月；满5年不足10年的，最长领取18个月；10年以上的，最长领取24个月。

> AI生成，仅供业务参考。具体以当地最新政策为准。`,
    '社保卡丢失后补办流程是什么？': `社保卡丢失后补办流程如下：

1. **第一步：挂失**
   - 临时挂失：拨打12333社保服务热线进行临时挂失
   - 正式挂失：携带身份证到社保卡服务网点办理正式挂失

2. **第二步：补办申请**
   - 携带本人有效身份证件到社保卡合作银行服务网点
   - 填写《社会保障卡补（换）卡申请表》
   - 现场采集照片信息（如有需要）

3. **第三步：制卡与领卡**
   - 即时制卡：部分网点支持即时制卡，当场可取
   - 普通制卡：一般需要7-15个工作日，可选择邮寄

4. **补卡费用**：首次申领免费，补（换）卡按规定收取工本费（一般为20-25元）。
...
> AI生成，仅供业务参考。具体以当地社保经办机构为准。`,
    '工伤认定需要准备哪些申请材料？': `工伤认定申请需要准备以下材料：

1. **基本材料**：
   - 工伤认定申请表（含事故发生时间、地点、原因及伤害程度等基本情况）
   - 与用人单位存在劳动关系（包括事实劳动关系）的证明材料
   - 医疗诊断证明或者职业病诊断证明书（或者职业病诊断鉴定书）

2. **情形补充材料**：
   - 因履行工作职责受到暴力伤害的：提交公安机关或人民法院的判决书等有关证明
   - 因工外出期间受到伤害的：提交外出证明、事故证明材料
   - 上下班途中受到非本人主要责任交通事故伤害的：提交公安机关交通管理部门的事故责任认定书
   - 突发疾病死亡或在48小时内抢救无效死亡的：提交医疗机构的抢救记录和死亡证明

3. **申请时限**：
   - 用人单位：事故伤害发生之日起30日内
   - 职工本人或近亲属：事故伤害发生之日起1年内

4. **办理渠道**：向用人单位所在地的人力资源社会保障行政部门提出申请。

> AI生成，仅供业务参考。具体以当地人社部门最新政策为准。`,
    '高校毕业生就业补贴怎么申请？': `高校毕业生就业补贴申请流程如下：
...
4. **申请渠道**：
   - 线上：通过"高校毕业生就业服务平台"、各地人社官网
   - 线下：到户籍所在地或就业所在地的公共就业服务机构窗口办理

5. **补贴标准**：各地标准不同，一般参照当地最低工资标准或社保缴费基数的一定比例确定。

> AI生成，仅供业务参考。具体以当地人社部门最新政策为准。`,
    default: `根据人力资源社会保障惠民政策，关于"${question}"的相关解答如下：

**一、政策背景**
人力资源社会保障工作关系到人民群众切身利益，涵盖养老保险、失业保险、工伤保险、就业扶持等多个领域。

**二、主要内容**
根据国家及地方人社部门相关规定，建议您通过以下渠道获取精准信息：
- 拨打全国人社服务热线：**12333**
- 登录当地人社部门官方网站或政务服务平台
- 前往当地社保经办机构或公共就业服务机构咨询

**三、温馨提示**
人社政策因地区差异可能有所不同，具体办理条件、所需材料、办理流程请以当地人社部门最新公布的政策为准。

> AI生成，仅供业务参考。`,
  }

  const matchedKey = Object.keys(answers).find(k => question.includes(k) || k.includes(question))
  return {
    answer: answers[matchedKey || 'default'],
